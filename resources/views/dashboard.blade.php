    ...
    <div class="py-4">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div id="userDataSection" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="major" name="major" value="{{ $student->major }}" readonly
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        </div>
                        <div>
            ...
            <script>
                ...
                const provinceId = "{{ $student->province_id }}";
                const cityId = "{{ $student->city_id }}";
                const districtId = "{{ $student->district_id }}";

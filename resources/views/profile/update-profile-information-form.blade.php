<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="fullname" type="text" class="mt-1 block w-full" wire:model="state.fullname" required
        ...
        <div class="col-span-6 sm:col-span-4">
            <label for="role_id" class="block text-sm font-medium text-gray-700">{{ __('Peran') }}</label>
            ...
            <p class="mt-2 text-sm text-gray-500">This field is readonly and cannot be edited.</p>
        </div>
    </x-slot>
